...
@section('content')
<div class="mb-3">
    <h3 class="fw-bold mb-1" style="color: #1b5e3a;">Fasilitas Umum</h3>
    <p class="text-body-secondary" style="font-size: 0.9rem;">Fasilitas Umum ITSK RS dr. Soepraoen Kesdam V/BRW Malang</p>
</div>
    ...
    <div class="card-body p-3">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div class="d-flex flex-wrap gap-2">
                <!-- Total Fasilitas -->
                <div class="d-flex align-items-center p-2 border rounded" style="border-color: var(--cui-border-color) !important; border-radius: 10px !important; min-width: 220px;">
                ...
                <!-- Aktif -->
                <div class="d-flex align-items-center p-2 border rounded" style="border-color: var(--cui-border-color) !important; border-radius: 10px !important; min-width: 220px;">
                    <div class="bg-primary text-white me-3 d-flex justify-content-center align-items-center shadow-sm" style="border-radius: 8px; width: 48px; height: 48px;">
                        <svg class="icon" style="width: 24px; height: 24px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div>
                        <div class="text-success fw-bold" style="font-size: 0.8rem;">Aktif</div>
                        <div class="fw-bold text-success" style="font-size: 1.5rem; line-height: 1;">23</div>
                        <div class="text-body-secondary" style="font-size: 0.7rem;">Fasilitas Aktif</div>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center p-2 border rounded" style="border-color: var(--cui-border-color) !important; border-radius: 10px !important; min-width: 220px;">
                    ...
                    <div>
                        <div class="text-success fw-bold" style="font-size: 0.8rem;">Tidak Aktif</div>
                        <div class="fw-bold text-success" style="font-size: 1.5rem; line-height: 1;">2</div>
                        <div class="text-body-secondary" style="font-size: 0.7rem;">Fasilitas Tidak Aktif</div>
                    </div>
                </div>
            </div>
...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-3 gap-2">
    <div class="flex-grow-1" style="max-width: 400px;">
        <div class="input-group shadow-sm" style="border-radius: 6px; overflow: hidden;">
            <input type="text" class="form-control border-end-0" placeholder="Cari nama fasilitas, lokasi, dan penanggung jawab..." style="padding: 0.5rem 0.75rem; font-size: 0.85rem;">
    ...
    <div class="d-flex gap-2 align-items-end flex-wrap">
        <div>
            <label class="form-label text-success fw-bold mb-1" style="font-size: 0.75rem;">Jenis Fasilitas</label>
        ...
        <div>
            <label class="form-label text-success fw-bold mb-1" style="font-size: 0.75rem;">Status</label>
            <select class="form-select shadow-sm" style="border-radius: 6px; min-width: 130px; padding: 0.5rem 0.75rem; font-size: 0.85rem;">
            ...
            <table class="table table-borderless table-hover align-middle mb-0">
                <thead style="border-bottom: 1px solid var(--cui-border-color); background-color: var(--cui-tertiary-bg);">
                    <tr>
                        ...
                        <th class="text-success py-2" style="font-size: 0.8rem;">Nama Fasilitas</th>
                        <th class="text-success py-2" style="font-size: 0.8rem;">Jenis Fasilitas</th>
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-5">
                            <div class="d-flex flex-column align-items-center justify-content-center py-4">
                                <p class="text-body-secondary mb-0" style="font-size: 0.9rem;">Belum ada data yang di tambahkan</p>
                            </div>
                        </td>
                    </tr>
                </tbody>

...
<body class="bg-[#F4F7F6] text-gray-800 font-sans flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-[#144A32] text-white flex flex-col h-full flex-shrink-0 shadow-lg z-20">
        ...
        <div class="px-4 py-6 flex-1 overflow-y-auto">
            ...
            <nav class="space-y-1">
                <a href="/dashboard" class="flex items-center px-3 py-2.5 hover:bg-white/10 rounded-lg text-sm font-medium transition-colors text-gray-200">
                ...
                <a href="#" class="flex items-center px-3 py-2.5 bg-white/20 rounded-lg text-sm font-medium transition-colors">
        ...
        <div class="p-4 mt-auto">
            <a href="#" class="flex items-center px-3 py-2 hover:bg-white/10 rounded-lg text-sm font-medium transition-colors text-gray-200">
